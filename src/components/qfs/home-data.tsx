...
export const ecosystemCards = [
  {
    title: 'QFS Core',
    emoji: '⚛️',
    bgColor: 'bg-gradient-to-br from-[rgba(0,240,255,0.15)] to-[rgba(0,240,255,0.05)]',
    icon: <Atom className="w-6 h-6 text-[#00f0ff]" />,
    desc: 'Infraestructura tecnológica destinada a conectar los diferentes componentes del ecosistema QFS.',
  },
  {
    title: 'QFSPay',
    emoji: '💳',
    bgColor: 'bg-gradient-to-br from-[rgba(139,92,246,0.15)] to-[rgba(139,92,246,0.05)]',
  ...
  },
  {
    title: 'QFS Wallet',
    emoji: '👛',
    bgColor: 'bg-gradient-to-br from-[rgba(20,184,166,0.15)] to-[rgba(20,184,166,0.05)]',
    icon: <Wallet className="w-6 h-6 text-[#14b8a6]" />,
  ...
  },
  {
    ...
    emoji: '🔄',
    bgColor: 'bg-gradient-to-br from-[rgba(236,72,153,0.15)] to-[rgba(236,72,153,0.05)]',
    icon: <ArrowRightLeft className="w-6 h-6 text-[#ec4899]" />,
  ...
  },
  {
    ...
    emoji: '💳',
    bgColor: 'bg-gradient-to-br from-[rgba(245,158,11,0.15)] to-[rgba(245,158,11,0.05)]',
  ...
  },
  {
    ...
    emoji: '🏦',
    bgColor: 'bg-gradient-to-br from-[rgba(59,130,246,0.15)] to-[rgba(59,130,246,0.05)]',
    icon: <Landmark className="w-6 h-6 text-[#3b82f6]" />,
    desc: 'Integración progresiva de pagos, intercambio, gestión de activos y soluciones empresariales.',
  },
  {
    title: 'QFS Global Network',
    emoji: '🌍',
    bgColor: 'bg-gradient-to-br from-[rgba(0,240,255,0.1)] to-[rgba(139,92,246,0.1)]',
  ...
  },
  {
    title: 'QFS AI',
    emoji: '🤖',
    bgColor: 'bg-gradient-to-br from-[rgba(236,72,153,0.1)] to-[rgba(139,92,246,0.1)]',
    icon: <Bot className="w-6 h-6 text-[#ec4899]" />,
