      ...
      <section className="min-h-screen flex items-center justify-center pt-16 px-4">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <motion.p
            ...
            className="text-lg sm:text-xl text-slate-500 max-w-3xl mx-auto mb-10 leading-relaxed"
          >
            ...
            <span className="text-[#0d9488] font-medium">seguridad criptográfica avanzada</span>,{' '}
          ...
          >
            <button className="quantum-btn-solid px-8 py-3.5 rounded-2xl text-sm font-semibold flex items-center gap-2 cursor-pointer">
              Explorar QFS <ChevronRight className="w-4 h-4" />
            </button>
            <button className="quantum-btn px-8 py-3.5 rounded-2xl text-sm font-medium flex items-center gap-2 cursor-pointer">
              QFS Wallet
            </button>
            <button className="quantum-btn px-8 py-3.5 rounded-2xl text-sm font-medium flex items-center gap-2 cursor-pointer" style={{ borderColor: 'rgba(124,58,237,0.2)', color: '#7c3aed' }}>
              QFSPay
            </button>
          </motion.div>
          ...
          <motion.div
            ...
            className="flex flex-wrap justify-center gap-3 text-xs text-slate-400 font-mono"
          >
            {['Technology', 'Digital Finance', 'Security', 'Decentralization', 'Global Connectivity'].map((tag) => (
              <span key={tag} className="px-3 py-1.5 rounded-full border border-gray-200 bg-white/60">
                {tag}
              </span>
            ))}
          </motion.div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            {pillars.map((p, i) => (
              ...
              >
                <div
                  className="w-14 h-14 rounded-2xl mx-auto mb-4 flex items-center justify-center bg-gradient-to-br from-blue-50 to-violet-50 text-[#2563eb] group-hover:scale-110 transition-transform"
          ...
          >
            {securityFeatures.map((feat, i) => (
              <motion.div
                ...
                custom={i}
                variants={fadeUp}
                className="flex items-center gap-3 px-5 py-3.5 rounded-xl bg-white border border-gray-100 hover:border-blue-200 transition-colors"
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-16">
            ...
            >
              ...
              <motion.p variants={fadeUp} className="text-sm text-slate-500 mb-6 leading-relaxed">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            >
              ...
              <motion.p variants={fadeUp} className="text-sm text-slate-500 mb-4 leading-relaxed">
                Conecta el ecosistema digital QFS con soluciones de pago físicas y digitales del mundo real.
              </motion.p>
              <motion.div variants={fadeUp} className="flex items-center gap-2 text-xs font-mono text-slate-400 py-3 flex-wrap">
